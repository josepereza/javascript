...
let g = new Function();  // objeto de clase Function. A evitar.
...
let copia_superficial = Object.assign({}, persona);  
...
Los objetos tiene propiedades y métodos.
...
Sólo disponible a partir de ES6. Es azúcar sintáctico, puesto que en el fondo Javascript sigue siendo un lenguage basado en prototipos.
...
console.table (agenda);                     // Muestra en forma de tabla. Sólo disponible para el navegador, no Nodejs
```
